...
#[async_trait]
impl Adapter for OllamaProvider {
    ...
    async fn image_generation(
        ...
        Err(ProviderError::CapabilityNotSupported("image generation is not supported by ollama".to_string()))
    }
    ...
    async fn image_edit(
        ...
        Err(ProviderError::CapabilityNotSupported("image edit is not supported by ollama".to_string()))
    }
    ...
    async fn video_generation(
        ...
        Err(ProviderError::CapabilityNotSupported("video generation is not supported by ollama".to_string()))
    }
    ...
    async fn audio_tts(
        ...
        Err(ProviderError::CapabilityNotSupported("audio TTS is not supported by ollama".to_string()))
    }
    ...
    async fn audio_stt(
        ...
        Err(ProviderError::CapabilityNotSupported("audio STT is not supported by ollama".to_string()))
    }
...
mod tests {
    ...
    fn dummy_model() -> Model {
        Model {
            id: Uuid::nil(),
            public_id: "llama3-70b".to_string(),
            provider: "ollama".to_string(),
            provider_profile_id: Uuid::nil(),
            provider_model_id: "llama3:70b".to_string(),
    ...
    async fn unsupported_capabilities_return_error() {
        let client = OllamaAdapter::new();
        let profile = dummy_profile("http://localhost:11434/v1".to_string());
        let err = client
