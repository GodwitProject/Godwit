...
impl Adapter for LlamaCppProvider {
    ...
    async fn image_generation(
        ...
        Err(ProviderError::CapabilityNotSupported("image generation is not supported by llama.cpp".to_string()))
    }
    ...
    async fn image_edit(
        ...
        Err(ProviderError::CapabilityNotSupported("image edit is not supported by llama.cpp".to_string()))
    }
    ...
    async fn video_generation(
        ...
        Err(ProviderError::CapabilityNotSupported("video generation is not supported by llama.cpp".to_string()))
    }
    ...
    async fn audio_tts(
        ...
        Err(ProviderError::CapabilityNotSupported("audio TTS is not supported by llama.cpp".to_string()))
    }
    ...
    async fn audio_stt(
        ...
        Err(ProviderError::CapabilityNotSupported("audio STT is not supported by llama.cpp".to_string()))
    }
