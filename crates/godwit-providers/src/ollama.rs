...
impl Adapter for OllamaProvider {
    ...
    async fn image_generation(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "image generation is not supported by ollama".to_string(),
        ))
    }
    ...
    async fn image_edit(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "image edit is not supported by ollama".to_string(),
        ))
    }
    ...
    async fn video_generation(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "video generation is not supported by ollama".to_string(),
        ))
    }
    ...
    async fn audio_tts(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "audio TTS is not supported by ollama".to_string(),
        ))
    }
    ...
    async fn audio_stt(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "audio STT is not supported by ollama".to_string(),
        ))
    }
    ...
    async fn create_batch(
        ...
        Err(ProviderError::CapabilityNotSupported(
            "batch is not supported for Ollama".to_string(),
        ))
    }
